...
class DocenteGrupoController extends Controller
{
    ...
    $docentesGrupos = $query->with('docente', 'grupo')
        ->orderBy('id', 'desc')
        ->simplePaginate(10);
    $docentesGrupo = $query->orderBy('id', 'desc')->simplePaginate(10);
    ...
    return redirect()->route('docentes_grupos.index')
        ->with('success', 'Docente grupo actualizado correctamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('docentes_grupos.index')
            ->with('success', 'Docente grupo eliminado correctamente.');
    }
}
